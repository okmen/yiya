package com.bbyiya.utils.picture;
 ...
 * resizing, rotating, flipping? * Plus it let抯 you do some really cool affects.
...
public class EazyImage {
	 ...
	 * @param imageFile
	 */
	public EazyImage(File imageFile) {
		try {
	 ...
	 * @param imageFilePath
	 */
	public EazyImage(String imageFilePath) {
	...
	public void combineWithPicture(EazyImage image2) {
		combineWithPicture(image2.getAsBufferedImage(), 2, null);
	}

	public void combineWithPicture(EazyImage image2, int jump) {
		combineWithPicture(image2.getAsBufferedImage(), jump, null);
	}

	public void combineWithPicture(EazyImage image2, Color ignoreColor) {
		combineWithPicture(image2.getAsBufferedImage(), 2, ignoreColor);
	}

	public void combineWithPicture(EazyImage image2, int jump, Color ignoreColor) {
	...
	public static void main(String[] args) {
		...
		EazyImage image = new EazyImage("c:/pics/p1.jpg");
