...
public class WxPayUtils {
	...
	private static String genProductArgs(String ipStr, double totalprice, String orderNo, String nonceStr) {
		try {
			...
			packageParams.add(new BasicNameValuePair("body", "订单：" + orderNo));// "订单:"+orderNo
			packageParams.add(new BasicNameValuePair("attach", "订单：" + orderNo));
			...
			packageParams.add(new BasicNameValuePair("product_id", "订单：" + orderNo));
